...
//writeArchive("chrono",
    ...
    //true, // display thumbnail
  //  true  // display number
//);

writeArchive("lastfirst", 10, maxpg, 0, true, true);

writeArchive("volume-1", 1, 3, -1, true, false)

writeArchive("chapter2", 4, 9, -1,true,false);

writeArchive("chapter3", 9, 12, -1,true,false);

writeArchive("chapter4", 13, 15, -1,true,false);
